...
export default function BuyerBrowse({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        {[
          { name: "Home", image: require('../assets/home-icon.png') },
          { name: "Products", image: require('../assets/products-icon.png') },
          { name: "Learn", image: require('../assets/learn-icon.webp') },
          { name: "AI Chat", image: require('../assets/chat-icon.png') }
        ].map((item, index) => {
