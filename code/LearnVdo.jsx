...
export default function LearnVdo({ navigation }) {
  ...
  {[
    ...
    >
      ...
      >
        ...
        {/* Articles List (Only 2 cards) */}
        <View style={styles.articleContainer}>
          {/* Rice Cultivation */}
          <View style={styles.articleCard}>
            <Image
              source={require("../assets/water-pump.jpg")}
              style={styles.articleImage}
            />
            <View style={styles.articleContent}>
              <Text style={styles.articleTitle}>
                Proper Rice Transplanting Method
              </Text>
              <Text style={styles.articleDesc}>
                Video Tutorial: How to Transplant Rice Properly.
              </Text>
              <View style={styles.articleFooter}>
                <View style={styles.footerItem}>
                  ...
                  />
                  <Text style={styles.articleDate}>Dec 12, 2024</Text>
                </View>
                <View style={styles.footerItem}>
                  <Image
                    ...
                    style={styles.footerIcon}
                  />
                  <Text style={styles.articleTime}>15 min</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          <View style={styles.articleCard}>
            ...
            <View style={styles.articleContent}>
              ...
              <Text style={styles.articleDesc}>
                Method of Making Organic Pesticide with Household Ingredients.
              </Text>
              <View style={styles.articleFooter}>
                <View style={styles.footerItem}>
                  <Image
                    ...
                    style={styles.footerIcon}
                  />
                  <Text style={styles.articleDate}>Dec 9, 2024</Text>
                </View>
                <View style={styles.footerItem}>
                  <Image
                    source={require("../assets/clock.png")}
                    style={styles.footerIcon}
                  />
                  <Text style={styles.articleTime}>12 min</Text>
                </View>
              </View>
            </View>
          </View>
  ...
  {[
    ...
    { name: "Learn", img: require("../assets/learn-icon.webp"), route: "LearnVdo" },
